...
$logFilePath = "c:\FWLogs\pfirewall.log"
$reportLogPath = "c:\FWLogs\abuseipdb_reporting.log"

# Your AbuseIPDB API key
$apiKey = "7400fd1ffb51dcc8e22f7cb22f37d72053c5ecda7f80ba51d079f0a040934f893f62e47d0dd0b1ea"
